			...
			<div class="panel panel-primary">
				...
				<div class="panel-body">
					<sf:form class="form-horizontal" modelAttribute="product" 
														action="${contextPath}/manage/product" method="post"
					   ...
					   <div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-md-8">
								<sf:select path="productCatId" items="${categories}" 
	  ...
	  <div class="modal-dialog" role="document">
	    <div class="modal-content">
	      ...
	      <div class="modal-body">
	         ...
	         <sf:form id="categoryForm" class="form-horizontal" modelAttribute="addCategory" action="${contextPath}/manage/category" method="POST">
